...
switch ($action)
{
  ...
  case 'options' :
	...
	Ta opcja musi być włączona aby śledzić aktywność użytkowników w tym, licznik użytkowników online.
	This must be enabled to keep track of most user activity, including counts of online members. Znacznie zwiększa aktywność bazy danych.<br /><br />
  ...
  default :
	...
	<b>Informacje o</b><br />
	Pokaż profil tego użytkownika (można również kliknąć na nazwę wyświetlaną)<br /><br />
	<b>Edycja</b><br />
	...
	<b>Kasowanie</b><br />
	Całkowicie usuwa danego użytkownika z serwisu (wpisy użytkownika na forum, komentarze itd. zostaną oznakowane'Użytkownik skasowany')
	";
}
