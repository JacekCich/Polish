...
case 'times' :
  ...
  Blokada będzie obowiązywać przez czas określony; po którym uzyska dostę do określonej strony.';
  break;
case 'options' :
...
Wpisanie adresu IP z jedym lub większą ilością wieloznaczników w końcowych blokach, np. 123.123.123.* lub 214.098.*.*, zablokuje użytkowników odwiedzających Twoją stronę ze wskazanej puli adresów IP. (Pamiętaj, że musza to być dokładnie 4 grupy cyfr lub wieloznaczniki)<br /><br />
...
case 'list' :
default :
$text = 'Ta strona przedstawia listę wszystkich adresów IP, nazw hostów i adresów e-mail, które są zablokowane.
(Zablokowani użytkownicy są wyświetlani na stronie administrowania użytkownikami)<br /><br />
