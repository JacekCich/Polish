...
$action = e107::getParser()->toDB(varset($_GET['mode'],'makemail'));
  ...
  switch ($action)
  {
	...
	case 'saved' :
	  ...
	  break;
	case 'pending' :
		$text = 'Lista e-maili przygotowane do wysyłania, wraz z aktualnym statusem. Zadaniem charmonogramu wysyłania poczty będzie przetwarzać te e-maile, jak to jest w planie, z uwzględnieniem
najwcześniejszych terminów i najnowszych do wysłania';
		break;
	case 'held' :
		$text = 'Lista e-maili, które zostały przygotowane do wysłania, ale jeszcze nie wysłane';
		break;
	case 'sent' :
	...
	case 'prefs' :
	  ...
	  Zadane wartości zależeć będą od hosta poczty oraz od iliści wysyłanych e-maili; jest możliwe wpisanie od dużej wartości do zera, tak że kolejka wysyłanych e-maili opróżniana jest natychmiastowo. Zazwyczaj najlepiej jest wysyłać mniej niż 500 e-maili na godzinę.<br /><br />';
