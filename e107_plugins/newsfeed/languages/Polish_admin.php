...
[h=4]Okres aktualizacji w sekundach:[/h]
	Ilość sekunda jaka musi upłynąć zanim kanał zostanie zaktualizowany, na przykład, 1800: 30 minut, 3600: godzina.

[h=4]Aktywacja:[/h]
	tutaj możesz wskazać sekcję, w której będą wyświetlane utworzone przez Ciebie kanały wiadomości, aby zobaczyć wiadomości w postaci [b]menu kanału aktualności[/b]musisz je najpierw aktywować na stronie [link=".e_ADMIN."menus.php]Menadżera Menu[/link].
[h=4]Porada[/h]
	 Pod adresami [link=https://www.dmoz.org/Computers/Internet/On_the_Web/Syndication_and_Feeds/RSS/Directories/ external]dmoz[/link] lub [link=http://www.feedster.com/ external]feedster.com[/link]
	możesz znaleźć wiele aktualnych kanałów posortowanych według kategorii. Jeśli poszukujesz polskiego kanału wiadomości przejrzyj stronę [link=http://www.it-es.pl/ external]it-es[/link].");
